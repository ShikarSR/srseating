                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Cinema Seating. Reimagined.</h1>
                                        </Animation>
                                        <p className='para_text text-center px-0'>Transforming cinema environments with more than just comfort. </p>
                                    </div>
                                </div>
                                ...
                                <div className="feature-style-one-info p-0" >
                                    <div className="fun-fact">
                                        <div className="counter">
                                            <div className="timer">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/cinema/cinema_header.jpg" className='w-100' alt="leadership"/>
                                              </div>
                                        </div>
                                    </div>
