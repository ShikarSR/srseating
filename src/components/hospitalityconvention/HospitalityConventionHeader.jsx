...
const HospitalityConventionHeader = ({data}) => {
  return (
    <>
                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='800ms' duration="400ms">
                                            <h4>Hospitality & Convention Halls</h4>
                                        </Animation>
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Seating That Shapes the Experience.</h1>
                                        </Animation>
                                        <p className='para_text text-center px-0'>For spaces where people gather, connect, and enjoy.   </p>
                                    </div>
                                </div>
                                ...
                                <div className="feature-style-one-info p-0" >
                                    <div className="fun-fact">
                                        <div className="counter">
                                            <div className="timer">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/hospitalityconvention/header.jpg" className='w-100' alt="auditorium"/>
                                              </div>
                                        </div>
                                    </div>
...
export default HospitalityConventionHeader