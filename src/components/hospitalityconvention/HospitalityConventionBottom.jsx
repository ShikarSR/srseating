...
const HospitalityConventionBottom = () => {
  return (
    ...
    <div className='experience_comfort mt-0'>
            ...
            <div className="container">
                <h2 className=' font_54'>Let Comfort Take Center Stage.</h2>
                    <p className='font_28'>SR Seating helps your venue do more than host, it helps it inspire. 
Let’s elevate every experience with seating that sets the stage. 
 </p>
...
export default HospitalityConventionBottom