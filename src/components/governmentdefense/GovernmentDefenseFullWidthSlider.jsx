...
import AuditoriumListSlider from './GovernmentDefenseListSlider';

const CINEMA_IDS = [2,4,7,12];


const GovernmentDefenseFullWidthSlider = ({ sectionClass }) => {
                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='800ms' duration="400ms">
                                            <h4 className='sr_btn'>Seating That Upholds Discipline </h4>
                                        </Animation>
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Explore Seating for Defense, Assembly <br />Halls & Government Training.</h1>
                                        </Animation>
                                    </div>
                                </div>
                            ...
                            <div className="swiper-wrapper">
                                {cinemaProducts.map(allproduct =>
                                    <SwiperSlide key={allproduct.id} >
                                        <AuditoriumListSlider allproduct={allproduct} key={allproduct.id} />
                                    </SwiperSlide>
                                )}
                            </div>
                        </Swiper>
...
export default GovernmentDefenseFullWidthSlider;