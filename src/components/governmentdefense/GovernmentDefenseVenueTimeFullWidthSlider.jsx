...
const GovernmentDefenseVenueTimeFullWidthSlider = ({ sectionClass }) => {
                            ...
                            <div className="swiper-wrapper">
                                    <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/governmentdefense/slider3.jpg" alt="Planetarium" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>Planetarium,<br/> Bangalore</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    </SwiperSlide>
                                     ...
                                     <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/governmentdefense/slider1.jpg" alt="High Court" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>High Court,<br/>Tamil Nadu</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    </SwiperSlide>
                                      ...
                                      <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/governmentdefense/slider3.jpg" alt="slider1" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>Planetarium,<br/> Bangalore</p>
                                                        </div>
   ...
   <SwiperSlide  >
                                 ...
                                 <div className="global_btn">
                                     <button class="sr-btn">
                                         <Link className="font_22" to="/photo-gallery?filter=government" target='_blank'>
...
export default GovernmentDefenseVenueTimeFullWidthSlider;