...
const HomeTheaterTestimonial = ({ sectionClass }) => {
                                    ...
                                    <SwiperSlide className="swiper-slide">
                                        <div className="testimonial-style-two">
                                            <div className="item">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="info">
                                                        <h4 className='font_22'>Ankit Mehra</h4>
                                                        <span className='font_18'>Vistaar Theatres</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="testimonial-style-two">
                                            <div className="item">
                                                <div className="text-info">
                                                    <p className='font_18'>
                                                        We’ve worked with several seating vendors over the years, but SR Seating stands out for their attention to detail and engineering quality. Their tip-up mechanism is remarkably silent and smooth—exactly what our auditorium needed.
                                                    </p>
                                                </div>
                                                <div className="content">
                                                    <div className="thumb">
                                                    ...
                                                    <div className="info">
                                                        <h4 className='font_22'>Ritu Sharma</h4>
                                                        <span className='font_18'>New Horizon Educational</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default HomeTheaterTestimonial;