  ...
  return (
    ...
    <div className='experience_comfort mt-0'>
            ...
            <div className="container">
                <h2 className=' font_54'>Luxury Seating for Your Private Screenings.</h2>
                    <p className='font_28'>From sound to seat, your home theatre deserves the best. </p>
...
export default HomeTheaterBottom