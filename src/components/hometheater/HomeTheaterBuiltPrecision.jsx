...
const HomeTheaterBuiltPrecision = () => {
  return (
          ...
          <div className='three_box_wrapper mt-0'>
               ...
               <div className="container">
                ...
                onMouseLeave={() => setHovered(false)}
                        ...
                        >
                                 <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/hometheater/HomeTheatre.jpg" alt="Built with Precision" className='w-100 radius_top_right radius_top_left'/>
...
export default HomeTheaterBuiltPrecision