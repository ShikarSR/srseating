...
const AuditoriumVenueTimeFullWidthSlider = ({ sectionClass }) => {
                            ...
                            <div className="swiper-wrapper">
                                     ...
                                     <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/auditorium/Dssc.jpg" alt="slider1" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>DSSC Auditorium,<br/> Wellington</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    </SwiperSlide>
                                     ...
                                     <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/auditorium/slider2.jpg" alt="slider3" />
                                                    <div className="overlay">
                                                        <div className="info">
...
<SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/auditorium/slider7.jpg" alt="slider7" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>Ambedkar Bhavan, <br/>Bangalore</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    </SwiperSlide>
                                     ...
                                     <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/auditorium/slider6.jpg" alt="slider6" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>Basava Samithi,
<br/>Tamil Nadu</p>
                                     ...
                                     <SwiperSlide  >
                                        <div className="gallery-style-one">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/auditorium/slider3.jpg" alt="slider3" />
                                                    <div className="overlay">
                                                        <div className="info">
                                                            <p>Kalaivanar Arangam,
<br/>Tamil Nadu</p>
                                                        </div>
                                                    </div>
                                                </div>
                                 ...
                                 <div className="global_btn">
                                     <button class="sr-btn">
                                         <Link className="font_22" to="/photo-gallery?filter=auditoriums" target='_blank'>
...
export default AuditoriumVenueTimeFullWidthSlider;