...
import AuditoriumListSlider from './AuditoriumListSlider';

const CINEMA_IDS = [1,2, 4, 6];

const AuditoriumFullWidthSlider = ({ sectionClass }) => {
                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='800ms' duration="400ms">
                                            <h4 className='sr_btn'>Seats That Serve the Space</h4>
                                        </Animation>
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Seamlessly Fits Your Space. <br />Quiet, Elegant, Effective.</h1>
                                        </Animation>
                                    </div>
                                </div>
...
export default AuditoriumFullWidthSlider;