  ...
  return (
    ...
    <div className='experience_comfort mt-0'>
            ...
            <div className="container">
                <h2 className=' font_54'>Every Great Event Begins with the Right Seat.</h2>
                    <p className='font_28'>Find the perfect fit for your auditorium, built for presence, made to last.  </p>
...
export default AuditoriumBottom