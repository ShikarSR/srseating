...
const ProductComfort = () => {
  return (
    <section className='experience_comfort mt-0'>
            <div className="container">
                    <h2 className='font_64'>Experience the Comfort Firsthand.</h2>
                    <p className='font_28'>Ready to see how SR Seating can transform your space? Click below to schedule a visit.</p>
