  ...
  return (
    ...
    <div className='experience_comfort mt-0'>
            ...
            <div className="container">
                <h2 className=' font_54'>Every Seat Has a Story. Let Yours Begin with SR Seating.</h2>
                    <p className=' font_28'>Where engineering meets experience.  </p>
...
export default AboutFixedBottom