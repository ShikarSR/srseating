...
import EducationalListSlider from './EducationalListSlider';

const CINEMA_IDS = [1,2,11,12];

const EducationalFullWidthSlider = ({ sectionClass }) => {
                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='800ms' duration="400ms">
                                            <h4 className='sr_btn'>Purpose-Built for Education</h4>
                                        </Animation>
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Smart, Adaptable Seating for Academics.</h1>
                                        </Animation>
                                    </div>
                                </div>
                            ...
                            <div className="swiper-wrapper">
                                {cinemaProducts.map(allproduct =>
                                    <SwiperSlide key={allproduct.id} >
                                        <EducationalListSlider allproduct={allproduct} key={allproduct.id} />
                                    </SwiperSlide>
                                )}
                            </div>
                        </Swiper>
...
export default EducationalFullWidthSlider;