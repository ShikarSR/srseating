  ...
  return (
    ...
    <div className='experience_comfort mt-0'>
            ...
            <div className="container">
                <h2 className=' font_54'>Let Learning Feel Right, From the First Seat.</h2>
                    <p className='font_28'>We craft seats that keep students focused, engaged, and ready to absorb every moment. Let’s reimagine the classroom, together.  </p>
...
export default EducationalBottom