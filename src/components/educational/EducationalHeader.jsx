                                ...
                                <div className="col-xl-12 col-lg-12 pr-50 pr-md-15 pr-xs-15">
                                    <div className="information text-center">
                                        ...
                                        <Animation className='animate__animated animate__fadeInUp' delay='500ms' duration="400ms">
                                            <h1 className='font_64'>Learning Environments, Elevated.</h1>
                                        </Animation>
                                        <p className='para_text text-center px-0'>Comfort, concentration, and collaboration - built into every seat.  </p>
                                    </div>
                                </div>
                                ...
                                <div className="feature-style-one-info p-0" >
                                    <div className="fun-fact">
                                        <div className="counter">
                                            <div className="timer">
                                                    <img src="https://srseating.blr1.cdn.digitaloceanspaces.com/image/educational/header.jpg" className='w-100' alt="auditorium"/>
                                              </div>
                                        </div>
                                    </div>
